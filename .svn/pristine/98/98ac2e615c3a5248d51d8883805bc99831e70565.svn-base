<template>
    <div class="table">
        <div class="container">
            ...
            <el-table :data="tableData" border stripe style="width: 100%" v-loading="listLoading" element-loading-text="给我一点时间" class="p-table-center" stripe highlight-current-row>
        ...
        methods:{
            ...
            validTable(){
                ...
                for(let j=0; j<this.clientData.length; j++){
                    ...
                    if(this.radio==j){
                        this.clientData[j].isDef='1'
                    }else{
                        this.clientData[j].isDef='0'
                    }
                    if(this.clientData[j].cname==''){
                        ...
                        return false
                    }else if(this.clientData[j].isDef==1){
                        aaa=false;
                    }else{
                        ruleMsg=true;
                    }
            ...
            tableLineDelete(index, row){
                if(!row.guid){
                    ...
                    this.deleteData.push(this.clientData.splice(index,1)[0]);
                }
                if(this.clientData.length == 1){
                    this.isDisabled=true
                }
