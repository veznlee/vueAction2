        ...
        <div class="container">
            <div class="handle-box">
                ...
                <div align="right" class="search-right">
                    ...
                    <el-input v-model="listParam.condition" placeholder="部门编码/部门名称" @keyup.enter.native="search" class="handle-input"></el-input>
        ...
        <el-dialog :title="formTitle" :visible.sync="editVisible" width="30%" custom-class="mod-el-dialog" :close-on-click-modal="false">
            <el-form :rules="rules" ref="form" :model="form" status-icon label-width="100px">
                <el-form-item label="部门编码" prop="ccode">
                    <el-input v-model="form.ccode" disabled placeholder="部门编码自动生成"></el-input>
                </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getClassUser(){
                var classUser={onlyUsed:1};
                selectUserList(classUser).then(response =>{
                    if(response.data.code==0){
