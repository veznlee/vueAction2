                    ...
                    <div class="layout-wrap layout-blue">
                        <div class="layout-title">
                            ...
                            <div class="layout-title-r">
                                <el-select v-model="countParam.flag" placeholder="入库类型" class="handle-Mselect mr10" @change="initCountChart">
                                    <el-option label="采购入库" value="0"></el-option>
                                    <el-option label="生产入库" value="1"></el-option>
                                    <el-option label="退货入库" value="2"></el-option>
                                </el-select>
                                <el-date-picker v-model="countParam.date" type="month" placeholder="选择月" value-format="yyyy-MM" :clearable="false" class="handle-date" @change="initCountChart"></el-date-picker>
                            </div>
                        </div>
                ...
                <div class="grid-content bg-purple-dark">
                    <div class="layout-wrap layout-green">
                        <div class="layout-title">
                            <h4> 入库商品走势</h4>
                            <div class="layout-title-r">
                                <el-select v-model="proParam.flag" placeholder="入库类型" class="handle-Mselect mr10" @change="initProChart">
                                    <el-option label="采购入库" value="0"></el-option>
                                    <el-option label="生产入库" value="1"></el-option>
                                    <el-option label="退货入库" value="2"></el-option>
                                </el-select>
