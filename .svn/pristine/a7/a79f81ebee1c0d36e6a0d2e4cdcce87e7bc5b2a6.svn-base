<template>
    <div class="table">
        <div class="container">
            <div class="handle-box">
                ...
                <div align="right" class="search-right">
                    <el-select v-model="listParam.currentStep" filterable placeholder="当前步骤" class="handle-Mselect" @change="search">
                    ...
                    <el-select v-model="listParam.client" filterable placeholder="选择客户" class="handle-select" @change="search">
            ...
            <el-table :data="tableData" border stripe highlight-current-row style="width: 100%" v-loading="listLoading" element-loading-text="正在载入数据，请稍候…">
                ...
                <el-table-column prop="orderdetailInfo.clientName" align="center" label="客户" width="220"></el-table-column>
        ...
        <el-dialog title="预览" :visible.sync="printVisible" width="1085px" custom-class="mod-el-dialog">
            <div id="printArea">
                <el-form :rules="rules" ref="form" :model="form" status-icon label-width="100px">
                    ...
                    <el-form-item v-if="isIn" label="退回商品：" class="">
                        <div class="">
                    ...
                    <el-form-item v-if="!isIn" label="退回商品：">
        ...
        <el-dialog title="单据已归档，删除需审核" :visible.sync="delCheckVisible" width="300px" center>
            <div class="del-dialog-cnt">请输入删除意见:<el-input v-model="this.delOpinion"></el-input></div>
            <span slot="footer" class="dialog-footer">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                //修改接口及加上接口文件
                menuPosition: '28694170b86e4732a4a49f19c13cd199',
