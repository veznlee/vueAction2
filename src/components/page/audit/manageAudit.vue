    ...
    <div class="table">
        <div class="container">
            <div class="handle-box">
                ...
                <div align="right" class="search-right">
                    ...
                    <el-select v-model="listParam.processId" filterable placeholder="审核类型" class="handle-select" @change="search">
                    ...
                    <el-input v-model="listParam.code" placeholder="请输入单号" @keyup.enter.native="search" class="handle-input"></el-input>
                    <el-input v-model="listParam.title" placeholder="请输入标题" @keyup.enter.native="search" class="handle-input"></el-input>
                    <el-button type="primary" icon="search" @click="search">搜索</el-button>
                </div>
            </div>
            <el-table :data="tableData" border highlight-current-row stripe style="width: 100%" v-loading="listLoading" element-loading-text="正在载入数据，请稍候…">
                ...
                <el-table-column align="center" label="审核类型" sortable width="120">
                ...
                <el-table-column align="center" label="状态" sortable width="80">
                    <template slot-scope="scope">
                        <span v-if="scope.row.orderdetailInfo.status=='0'">待办</span>
                        <span v-if="scope.row.orderdetailInfo.status=='1'">已办</span>
                    </template>
                </el-table-column>
                <el-table-column prop="orderdetailInfo.operator" align="center" label="操作员" sortable width="120"></el-table-column>
                ...
                <el-table-column align="center" label="流程" min-width="300">
                    <template slot-scope="scope">
                        <span v-for="(item,index) in scope.row.taskNodeInfo" :key="index">
                ...
                <el-table-column label="操作" align="center" fixed="right" width="240">
                    <template slot-scope="scope">
                        <span v-for="(item,index) in scope.row.homepageHandleDesigning" :key="index">
                            ...
                            <el-button v-if="item.name=='agree' && item.anotherName!=''" type="success" size="small" @click="handleCheck(scope.$index, scope.row)">{{item.anotherName}}</el-button>
                            <el-button v-if="item.name=='agree' && item.anotherName==''" type="success" size="small" @click="handleCheck(scope.$index, scope.row)">审核</el-button>
        ...
        <el-dialog :title="formTitle" :visible.sync="editVisible" width="70%" custom-class="mod-el-dialog">
            ...
            <el-form :rules="rules" ref="form" :model="form" status-icon label-width="100px">
                ...
                <el-form-item v-if="isIn" label="入库商品：">
                ...
                <el-form-item v-if="!isIn" label="出库商品：">
                    <el-table :data="form.items" border style="width: 100%" key="tTable">
                        <el-table-column type="index" :index="indexMethod" fixed align="center" width="50" label="序号"></el-table-column>
                        <el-table-column label="商品编码" width="90" prop="ccode"></el-table-column>
                        ...
                        <el-table-column label="仓库" width="180" prop="storeCname"></el-table-column>
                        <el-table-column label="区域" width="150" prop="regionCname"></el-table-column>
                        <el-table-column label="号" width="190" prop="regionInfoCname"></el-table-column>
                        <el-table-column width="80" align="center" :render-header="renderHeader" fixed="right" v-if="!readonly.specificationOfGoods">
                            <template slot-scope="scope">
                                <el-button size="mini" type="danger" @click="tableLineDelete(scope.$index, scope.row)" :disabled="!canEdit || readonly.specificationOfGoods">删除</el-button>
                            </template>
            ...
            <span slot="footer" class="dialog-footer">
                <span v-for="(item,index) in buttonCtrl" :key="index">
        ...
        <el-dialog title="预览" :visible.sync="printVisible" width="1085px" custom-class="mod-el-dialog">
            ...
            <el-form :rules="rules" ref="form" :model="form" status-icon label-width="100px">
                ...
                <el-form-item v-if="isIn" label="入库商品：" class="">
                    <div class="">
