        ...
        <div class="container">
            <div class="handle-box">
                ...
                <div align="right" class="search-right">
                    <el-select v-model="listParam.processId" filterable placeholder="审核类型" class="handle-Mselect mr10" @change="search">
                    ...
                    <el-input v-model="listParam.code" placeholder="请输入单号" @keyup.enter.native="search" class="handle-input mr10"></el-input>
                    <el-input v-model="listParam.title" placeholder="请输入标题" @keyup.enter.native="search" class="handle-input mr10"></el-input>
            ...
            <el-table :data="tableData" border stripe highlight-current-row style="width: 100%" v-loading="listLoading" element-loading-text="正在载入数据，请稍候…">
                ...
                <el-table-column label="操作" align="center" width="130" fixed="right">
                    <template slot-scope="scope">
                        <span><el-button size="small" @click="handleView(scope.$index, scope.row)">查看</el-button></span>
            ...
            <el-form :rules="rules" ref="form" :model="form" status-icon label-width="100px">
                ...
                <el-form-item v-if="isIn" label="入库商品：">
                    <el-table :data="form.items" border style="width: 100%" key="oTable">
                        ...
                        <el-table-column label="商品名称" prop="cname" width="150"></el-table-column>
