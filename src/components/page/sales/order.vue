    ...
    <div class="table">
        <div class="container">
            <div class="handle-box">
                ...
                <div align="right" class="search-right">
                    ...
                    <el-select v-model="listParam.client" filterable placeholder="选择客户" class="handle-Mselect" @change="search">
                    ...
                    <el-input v-model="listParam.consignee" placeholder="请输出收货人" @keyup.enter.native="search" class="handle-input"></el-input>
                    <el-input v-model="listParam.consigneePhone" placeholder="请输出联系电话" @keyup.enter.native="search" class="handle-input"></el-input>
            ...
            <el-table :data="tableData" border stripe highlight-current-row style="width: 100%" v-loading="listLoading" element-loading-text="正在载出数据，请稍候…">
                ...
                <el-table-column prop="orderdetailInfo.clientName" align="center" label="客户" min-width="220"></el-table-column>
        ...
        <el-dialog title="预览" :visible.sync="printVisible" width="1085px" custom-class="mod-el-dialog">
            <div id="printArea">
                <el-form :rules="rules" ref="form" :model="form" status-icon label-width="100px">
                    ...
                    <el-form-item v-if="isIn" label="销售商品：" class="">
                        <div class="">
                    ...
                    <el-form-item v-if="!isIn" label="销售商品：">
        ...
        <el-dialog title="选择商品" :visible.sync="selectProductVisible" width="60%" custom-class="mod-el-dialog">
            <div class="handle-box">
                <div style="width: 100%" class="search-right">
                    <el-row :gutter="20">
                        ...
                        <el-col :span="5">
                            <el-select v-model="productParam.typeGuid" filterable placeholder="选择类别" @change="searchPro">
            ...
            <el-table :data="productList" border style="width: 100%">
                ...
                <el-table-column label="入库单号" align="center" width="200" prop="ccode"></el-table-column>
                ...
                <el-table-column label="入库时间" align="center" width="200" prop="inputDate"></el-table-column>
            </el-table>
            ...
            <div class="handle-box">
                <div style="width: 100%" class="search-right">
                    <el-row :gutter="20">
                        ...
                        <el-col :span="10">
                            <el-input v-model="linkParam.condition" placeholder="企业名称或联系人或联系人电话" @keyup.enter.native="searchCus"></el-input>
                        </el-col>
                        <el-col :span="1">
