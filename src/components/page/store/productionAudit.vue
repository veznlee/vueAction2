    ...
    <div class="table">
        <div class="container">
            ...
            <el-table :data="tableData" border stripe highlight-current-row style="width: 100%" v-loading="listLoading" element-loading-text="正在载入数据，请稍候…">
                ...
                <el-table-column prop="orderdetailInfo.title" align="center" label="标题" sortable width="200"></el-table-column>
                <el-table-column prop="orderdetailInfo.clientName" align="center" label="部门" min-width="180"></el-table-column>
