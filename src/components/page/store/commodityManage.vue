    ...
    <div class="table">
        <div class="container">
            ...
            <el-table :data="tableData" stripe border style="width: 100%" v-loading="listLoading" element-loading-text="给我一点时间" highlight-current-row>
                ...
                <el-table-column label="每托盘容量" width="120" align="center">
                    <template slot-scope="scope">
                        <span>{{ scope.row.palletCapacity }}</span>
                        <span>{{ scope.row.pdSpecificationBUnit }}</span>
                    </template>
                </el-table-column>
            ...
            <el-form :rules="rules" ref="form" :model="form" status-icon label-width="100px">
                ...
                <el-row :gutter="10">
                    <el-col :span="12" style="padding: 0">
                        <el-form-item label="每托盘容量" style="margin-bottom: 0" required>
                            <div class="grid-content bg-purple">
                                <el-col :span="18">
                                    <el-form-item prop="palletCapacity">
                                        <el-input placeholder="" v-model.number="form.palletCapacity"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                                    <el-form-item>
                    ...
                    <el-col :span="12" style="padding: 0">
                        <el-form-item label="库存预警值" style="margin-bottom: 0" required>
                            <div class="grid-content bg-purple">
                                <el-col :span="18">
                                    <el-form-item prop="warningNum">
                                        <el-input placeholder="" v-model.number="form.warningNum"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                                    <el-form-item>
                ...
                <el-form-item label="商品描述">
                    <el-input type="textarea" v-model="form.cdesc" :maxLength="200"></el-input>
                </el-form-item>
            </el-form>
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    palletCapacity: [
                        { required: true, message: '必填', trigger: 'blur'},
                        { validator:this.digitRule, trigger: 'blur'}
                    ],
                    warningNum: [{ required: true, message: '必填', trigger: 'blur' }],
                },
                imgUrl: '',
                historyName:''
            }
        ...
        methods: {
            ...
            handleAdd(){
                ...
                if(this.unitList.length==0){}else{
