                                        ...
                                        <el-card shadow="hover" :body-style="{padding: '0px'}">
                                            <div class="grid-content grid-con-wrap grid-con-1">
                                                ...
                                                <div class="grid-cont-right">
                                                    <router-link :to="{path:'/indexSellOrder',query:{status:'0'}}">
                                    ...
                                    <div class="grid-content bg-purple">
                                        <el-card shadow="hover" :body-style="{padding: '0px'}">
                                            <div class="grid-content grid-con-wrap grid-con-2">
                                                <i class="el-icon-view grid-con-icon"></i>
                                                <div class="grid-cont-right">
                                                    <router-link :to="{path:'/indexSellOrder',query:{status:'0',currentStep:'销售出库'}}">
                                    ...
                                    <div class="grid-content bg-purple">
                                        <el-card shadow="hover" :body-style="{padding: '0px'}">
                                            <div class="grid-content grid-con-wrap grid-con-3">
                                                <i class="el-icon-view grid-con-icon"></i>
                                                <div class="grid-cont-right">
                                                    <router-link :to="{path:'/salesBack',query:{status:'0',currentStep:'退货入库'}}">
                                                        <div class="grid-num">{{saleIn}}</div>
            ...
            getOrderData() {
                request({
                    ...
                    if(response.data.code==0){
                        ...
                        this.saleIn=resData.SalesReturnInHouseOrder
                        this.saleOut=resData.SellOutHouseOrder
                        this.auditNum=resData.SellOutHouse
                    }
                })
            },
            getWarnStore() {
