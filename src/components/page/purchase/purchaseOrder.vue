        ...
        <div class="container">
            <div class="handle-box">
                ...
                <div align="right" class="search-right">
                    ...
                    <el-select v-model="listParam.client" filterable placeholder="选择供应商" class="handle-Mselect" @change="search">
            ...
            <el-table :data="tableData" border stripe highlight-current-row style="width: 100%" v-loading="listLoading" element-loading-text="正在载入数据，请稍候…">
                ...
                <el-table-column prop="orderdetailInfo.clientName" align="center" label="供应商" width="220"></el-table-column>
        ...
        <el-dialog title="预览" :visible.sync="printVisible" width="1085px" custom-class="mod-el-dialog">
            <div id="printArea">
                <el-form :rules="rules" ref="form" :model="form" status-icon label-width="100px">
                    ...
                    <el-form-item v-if="isIn" label="采购商品：" class="">
                        <div class="">
                    ...
                    <el-form-item v-if="!isIn" label="采购商品：">
        ...
        <el-dialog title="选择供应商" :visible.sync="selectLinkVisible" width="40%" custom-class="mod-el-dialog">
            <div class="handle-box">
                <div style="width: 100%" class="search-right">
                    <el-row :gutter="20">
                        <el-col :span="24">
                            <el-input class="handle-input" v-model="linkParam.condition" placeholder="企业名称或联系人或联系人电话" @keyup.enter.native="searchCus"></el-input>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                //修改接口及加上接口文件
                menuPosition: '247f0a3b94344793868d3a3f0d3dbbb6',
