    ...
    <div class="table">
        ...
        <el-dialog title="选择商品" :visible.sync="selectProductVisible" width="60%" custom-class="mod-el-dialog">
            ...
            <el-table :data="productList" border style="width: 100%">
                ...
                <el-table-column label="商品名称" align="center" prop="cname" min-width="200"></el-table-column>
                <el-table-column label="商品数量" align="center" width="120" prop="restNum"></el-table-column>
