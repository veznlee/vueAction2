    ...
    <div class="table">
        <div class="container">
            <div class="handle-box">
                ...
                <div align="right" class="search-right">
                    <el-input v-model="listParam.condition" placeholder="规格编码/规格名称" @keyup.enter.native="search" class="handle-input mr10"></el-input>
            ...
            <el-table :data="tableData" border style="width: 100%" v-loading="listLoading" element-loading-text="给我一点时间" class="p-table-center" stripe highlight-current-row>
                ...
                <el-table-column prop="ccode" align="center" label="规格编码" sortable width="150">
                </el-table-column>
                <el-table-column prop="cname" label="规格名称" width="200">
                </el-table-column>
                <el-table-column prop="cdesc" label="规格描述" min-width="200">
                </el-table-column>
        ...
        <el-dialog :title="formTitle" :visible.sync="editVisible" width="30%" custom-class="mod-el-dialog" :close-on-click-modal="false">
            <el-form :rules="rules" ref="form" :model="form" label-width="80px">
                ...
                <el-form-item label="规格名称" prop="cname">
                ...
                <el-form-item label="规格描述" prop="cdesc">
        ...
        methods:{
            ...
            isExist(rule, value, callback){
                ...
                request({
                    ...
                    method: 'get',
                    params: {cname:this.form.cname,ctype:'0'}
                }).then(response => {
                    if(response.data.code==0){
                        callback();
                    }else if(response.data.code==100){
                        callback(new Error('规格名称已存在，请重新输入'))
                    }
                })
            }
        }
